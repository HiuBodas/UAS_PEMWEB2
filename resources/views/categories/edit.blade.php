<x-app-layout>
    <x-slot name="header">
        <h2 class="pos-page-title">{{ __('Edit Kategori') }}</h2>
        <p class="pos-page-subtitle">MODIFY EXISTING PRODUCT CATEGORY DETAILS</p>
    </x-slot>
            ...
            <div class="glass-card-body">
                <form action="{{ route('categories.update', $category->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input id="nama_kategori" name="nama_kategori" type="text" class="pos-input" value="{{ old('nama_kategori', $category->nama_kategori) }}" required autofocus />
                        @error('nama_kategori')
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">{{ __('Update Kategori') }}</button>
