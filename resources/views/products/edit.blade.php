<x-app-layout>
    <x-slot name="header">
        <h2 class="pos-page-title">{{ __('Edit Produk') }}</h2>
        <p class="pos-page-subtitle">MODIFY PRODUCT INFORMATION AND LEVEL OF STOCKS</p>
    </x-slot>
            ...
            <div class="glass-card-body">
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input id="nama_produk" name="nama_produk" type="text" class="pos-input" value="{{ old('nama_produk', $product->nama_produk) }}" required />
                        @error('nama_produk')
                            <div class="pos-error"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="14" height="14" style="display:inline;vertical-align:middle;margin-right:4px;"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" /></svg> {{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-grid-3">
                        <div class="form-group">
                            ...
                            <input id="harga_beli" name="harga_beli" type="number" class="pos-input mono" value="{{ old('harga_beli', $product->harga_beli) }}" required min="0" />
                            @error('harga_beli')
                                <div class="pos-error"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="14" height="14" style="display:inline;vertical-align:middle;margin-right:4px;"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" /></svg> {{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="harga_jual" name="harga_jual" type="number" class="pos-input mono" value="{{ old('harga_jual', $product->harga_jual) }}" required min="0" />
                            @error('harga_jual')
                                <div class="pos-error"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="14" height="14" style="display:inline;vertical-align:middle;margin-right:4px;"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" /></svg> {{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label for="stok" class="pos-label">{{ __('Stok') }}</label>
                            <input id="stok" name="stok" type="number" class="pos-input mono" value="{{ old('stok', $product->stok) }}" required min="0" />
                            @error('stok')
                                <div class="pos-error"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="14" height="14" style="display:inline;vertical-align:middle;margin-right:4px;"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" /></svg> {{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    {{-- Gambar Produk --}}
                    <div class="form-group">
                        <label class="pos-label">Gambar Produk <span style="font-weight:400;color:var(--text-muted);">(Opsional — kosongkan jika tidak ingin mengubah)</span></label>

                        @if($product->gambar)
                        <div style="margin-bottom: 0.75rem; display:flex; align-items:center; gap:1rem;">
                            <img src="{{ Storage::url($product->gambar) }}" alt="Gambar Produk"
                                style="height:80px; width:80px; object-fit:cover; border-radius:0.5rem; border:1px solid rgba(255,255,255,0.08);">
                            <span style="font-size:0.78rem; color:var(--text-muted);">Gambar saat ini. Upload baru untuk mengganti.</span>
                        </div>
                        @endif
                        ...
                        " onmouseover="this.style.borderColor='rgba(99,102,241,0.7)'" onmouseout="this.style.borderColor='rgba(99,102,241,0.35)'">
                            <img id="gambar-preview" src="" alt="Preview" style="display:none; max-height:110px; border-radius:0.5rem; object-fit:cover;">
                            <span id="gambar-placeholder" style="text-align:center;">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6366f1" width="30" height="30" style="margin:auto;"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M3.75 19.5h16.5M12 3v9m0 0l-2.25-2.25M12 12l2.25-2.25" /></svg>
                                <span style="display:block;margin-top:.4rem;color:var(--text-muted);font-size:.8rem;">Upload gambar baru</span>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">{{ __('Update Produk') }}</button>
